    ...
    <script type="application/id+json">
        {
            ...
            "name": "{{$category->side_title}}",
            "description": "{{$category->side_description}}",
                ...
                <div class="coupon__body">
                    ...
                    <div class="coupon__right">
                        <div class="coupon__desc">
                            ...
                            <a
                            class="text-black h-100 row align-items-center"
                            title='{{ $coupon->title }}'
                            onclick="
                            @if($coupon->offer == 0)
                            window.location='{{$coupon->link}}'
                        ...
                        <div class="coupon__action">
                            <a
                                class="clickout coupons-grid btn text-white"
        ...
        <div class="col-lg-4" data-area="SB">
            ...
            <div class="sidebar" id="sidebar">
                ...
                <div class="d-none d-sm-block">
                    ...
                    <div class="widget widget--seo-text" style="font-size: large;" data-area="SEO">
                        <span>{{ $category->side_title }}</span>
                        <span> {!! $category->side_description !!} </span>
                    </div>
