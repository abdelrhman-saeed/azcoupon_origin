        ...
        <div class="page-content">
            ...
            <div class="card">
              <div class="card-body p-4">
                  ...
                  <hr/>
                    <form action="{{ route('admin.coupons.update', $offer) }}" method='POST'>
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <x-admin.form.input value="{!! old('title', $offer->title) !!}" required name='title' label='Offer Title' id='offer_title'/>

                                        <x-admin.form.textarea value="{!! old('description', $offer->description) !!}" name='description' label='Offer Description' id='offer_description' rows="3"/>

                                        <div class="row">
                                            <div class="col-lg-6">
                                                <x-admin.form.input type='url' value="{!! old('link', $offer->link) !!}" name='link' label='Offer Link' id='offer_link'/>
                                            </div>

                                            <div class="col-lg-4">
                                                <x-admin.form.input step="any" value="{{ old('discount', $offer->discount) }}" name='discount' type="number" label='offer Discount' id='offer_discount'/>
                                            </div>

                                            <div class="col-lg-2 mt-2">
                                                <label class='form-label'></label>
                                                <select name='preference' class="single-select form-select select2-hidden-accessible" aria-hidden="true">
                                                    <option {{ $offer->preference == '%' ? 'selected' : '' }} value='%'>%</option>
                                                    <option {{ $offer->preference == '$' ? 'selected' : '' }} value='$'>$</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class='row'>
                                            <div class='col-lg-6'>
                                                <x-admin.form.date value="{{ old('expire_date', $offer->expire_date == '0000-00-00' ? '' : $offer->expire_date) }}" name='expire_date' label='Expire date' id='date' placeholder="2021-09-09" data-dtp="dtp_Usa8T"/>
                                            </div>
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-4'>
                                                            ...
                                                            <div class="form-check form-switch">
                                                                <input {{ $offer->featured ? 'checked' : '' }} name='featured' class="form-check-input" type="checkbox" id="featured_checkbox">
                                                        ...
                                                        <div class='col-md-4'>
                                                            ...
                                                            <div class="form-check form-switch">
                                                                <input {{ $offer->verified ? 'checked' : '' }} name='verified' class="form-check-input" type="checkbox" id="verified_checkbox">
                                                        ...
                                                        <div class='col-md-4'>
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input" type="checkbox" {{ $offer->online ? 'checked' : '' }} name='online' id="online_checkbox">
                                        ...
                                        <div class='mb-3'>
                                            <div class='row'>
                                                <div class='col-md-4'>
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <input {{ $offer->top_coupon ? 'checked' : '' }} class="form-check-input" type="checkbox" name='top_coupon' id="top_coupon_checkbox">
                                                ...
                                                <div class='col-md-4'>
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <input {{ $offer->expire_soon ? 'checked' : '' }} class="form-check-input" type="checkbox" name='expire_soon' id="expire_soon_checkbox">
                                                ...
                                                <div class='col-md-4'>
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <input {{ $offer->super_featured ? "checked" : "" }} class="form-check-input" type="checkbox" name="super_featured" id="super_featured_checkbox">
                                                ...
                                                <div class="input-group">
                                                    <select name='store_id' class="single-select form-select select2-hidden-accessible" aria-hidden="true">
                                                        @foreach($stores as $key => $store)
                                                            <option {{ $offer->store_id == $key ? 'selected' : '' }} value='{{ $key }}'>{{ $store }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="input-group" >
                                                    <select multiple name='category_ids[]' class="single-select form-select select2-hidden-accessible" aria-hidden="true">
                                                        ...
                                                        @foreach($categories as $key => $category)
                                                            <option {{ $offer->categories->contains($key) ? 'selected' : '' }} value='{{ $key }}'>{{ $category }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="input-group" >
                                                    <select multiple name='event_ids[]' class="single-select form-select select2-hidden-accessible" aria-hidden="true">
                                                        @foreach($events as $key => $event)
                                                            <option {{ $offer->events->contains($key) ? 'selected' : '' }} value='{{ $key }}'>{{ $event }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row mb-3 publish-row">
                                            <div class="col-lg-2">
                                                ...
                                                <div class="input-group">
                                                    <select name='publish_type' class="single-select form-select select2-hidden-accessible" aria-hidden="true">
                                                        <option {{ $offer->publish_type == 'now' ? 'selected' : '' }} value='now'>Now</option>
                                                        <option {{ $offer->publish_type == 'schedule' ? 'selected' : '' }} value='schedule'>Schedule</option>
                                                    </select>
                                            ...
                                            <div class="col-lg-5 schedule_from_col {{ $offer->publish_type == 'now' ? 'd-none':'' }}">

                                                <x-admin.form.date value="{{ old('schedule_from', $offer->schedule_from) }}" name='schedule_from' label='Schedule From Date' id='schedule_from' placeholder="2021-09-09" data-dtp="dtp_Usa8T"/>
                                            ...
                                            <div class="col-lg-5 schedule_to_col {{ $offer->publish_type == 'now' ? 'd-none':'' }}">

                                                <x-admin.form.date value="{{ old('schedule_to', $offer->schedule_to) }}" name='schedule_to' label='Schedule To Date' id='schedule_to' placeholder="2021-09-09" data-dtp="dtp_Usa8T"/>
                                        ...
                                        @forelse($offer->couponterms as $term)
                                        <div class="row mb-3">
                                            <div class="col-lg-10">
                                                <x-admin.form.input value='{{ $term->term }}' type='text' name='terms[]' label='Offer Term' id=''/>
                                            </div>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-12'>
                                                <x-admin.form.button type='btn-primary'>Update Offer</x-admin.form.button>

                                                <a href='#'
                                                onclick="
                                                if( confirm('You are gonna delete offer permanently, proceed ?') == true ) { event.preventDefault();document.getElementById('delete_offer_form').submit(); }"
                                                class='btn btn-danger px-5'>Delete Offer</a>
                                            </div>
                                        </div>
                    ...
                    <form class='hidden' id='delete_offer_form' action="{{ route('admin.coupons.destroy', $offer) }}" method='POST'>
                        @csrf @method('DELETE')
                    </form>
