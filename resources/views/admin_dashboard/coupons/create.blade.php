                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <x-admin.form.input value="{{ old('title') }}" required name='title' label='Coupon Title' id='coupon_title'/>

                                        <x-admin.form.textarea value="{{ old('description') }}" name='description' label='Coupon Description' id='coupon_description' rows="3"/>

                                        <div class="row">
                                            <div class="col-lg-6">
                                                <x-admin.form.input value="{{ old('code') }}" name='code' label='Coupon Code' id='coupon_code'/>
                                            </div>

                                            <div class="col-lg-4">
                                                <x-admin.form.input step='any' value="{{ old('discount') }}" name='discount' type="number" label='Coupon Discount' id='coupon_discount'/>
                                            </div>
                                        ...
                                        <x-admin.form.input type='url' value="{{ old('link') }}" name='link' label='Coupon Link' id='coupon_link'/>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-6'>
                                                <x-admin.form.button type='btn-primary'>Add Coupon</x-admin.form.button>
                                            </div>
                                        </div>
