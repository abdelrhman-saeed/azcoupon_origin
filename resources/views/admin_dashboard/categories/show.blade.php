...
@section("wrapper")
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="card">
                <div class="row g-0">
                    ...
                    <div class="col-md-2 border-end text-center">
						<img class='category-image' width='120' src="{{ $category->image ? asset('storage/' . $category->image->path) : asset('admin_assets/images/categories/category_placeholder.png') }}" class="img-fluid" alt="...">
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-3 py-3">
                            ...
                            <div>
                                ...
                                <i class="lni lni-user"></i> {{ $category->user->name }}
                            
                            </div>

                        </div>
                        
                        <p class="card-text fs-6">{{ $category->description }}</p>
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-9">{{ count($category->coupons) }}</dd>
                        </dl>

                        <hr>
                        
                        <div class="d-flex gap-3 mt-3">
                            <a href="{{ route('admin.categories.edit', $category) }}" class="btn btn-primary">Edit Category <i class='bx bxs-edit'></i></a>
                            <a 
                            onclick="event.preventDefault();document.getElementById('category_delete_form').submit();"
                            href="#" 
                            class="btn btn-outline-danger">
                                <span class="text">Delete Category</span> <i class='bx bxs-trash'></i>
                            </a>

                            <form id='category_delete_form' action="{{ route('admin.categories.destroy', $category) }}" method='POST'>
                                @csrf
                                @method('DELETE')
            ...
            <div class='show-category-coupons coupons-offers-container'>
                ...
                <div class='card p-2'>
                    <div class='row mb-2'>
                        ...
                        <div class='col-md-4'>
                            <form method='POST' class='pluck-form' action="{{ route('admin.categories.coupons_action') }}">
                                @csrf
                ...
                <div class="row row-cols-1 row-cols-lg-3">
                    ...
                    @empty
                    <p class='muted'>Category has no Coupons</p>
                    @endforelse
                </div>
            </div>


            <div class='show-category-offers coupons-offers-container'>
                                    ...
                                    <div class="card-body" style='min-height: 150px;'>
                                        ...
                                        <div class="clearfix">
                                            <p class="">
                                                ...
                                                href='#'
                                                onclick="
                                                    if( confirm('You are gonna delete coupon permanently, proceed ?') == true ) { event.preventDefault(); document.getElementById('online_change_{{ $coupon->id }}').submit(); }"
                                                class="btn btn-sm ms-2 text-white bg-warning">
                                                    @if($coupon->online)
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye-off text-white"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg>
                                                    @else
            ...
            <h6 class="text-uppercase mb-0">Latest Categories</h6>
            <hr/>

            <div class="row row-cols-1 row-cols-lg-3">
                @foreach($latest_added as $category)

                <div class="col">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img width='120' height='120' src="{{ $category->image ? asset('storage/' . $category->image->path) : asset('admin_assets/images/categories/category_placeholder.png') }}" class="img-fluid p-3" alt="Category Image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                            ...
                            <div class="clearfix m-3">
                                <p class="">
                                    ...
                                    <a 
                                    onclick="
                                        if( confirm('You are gonna delete category permanently, proceed ?') == true ) { event.preventDefault();document.getElementById('category_delete_form_{{ $category->id }}').submit(); }"
                                    href="#" 
                                    class="btn btn-danger btn-sm">
                                        <span class="text">Delete</span>
                                    </a>

                                    <form id='category_delete_form_{{ $category->id }}' action="{{ route('admin.categories.destroy', $category) }}" method='POST'>
                                        @csrf
                                        @method('DELETE')
