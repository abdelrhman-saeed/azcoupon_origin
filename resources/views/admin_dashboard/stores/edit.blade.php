            ...
            <div class="card">
              <div class="card-body p-4">
                  ...
                  <hr/>
                        ...
                        <div class="form-body mt-4">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            <x-admin.form.button type='btn-primary'>Update Store</x-admin.form.button>
                                            
                                            <a href='#' 
                                            onclick="
                                                if( confirm('You are gonna delete store permanently, proceed ?') == true ) { event.preventDefault();document.getElementById('delete_store_form').submit() } "
                                                class='btn btn-danger px-5'>Delete Store</a>
                                        </div>
                                           
                                        <div class='row'>
                                            <div class='col-md-10'>
                                                <x-admin.form.input notes='To Add DATE in your SEO Title Just Add phrase "(v_date)" at any place you want' value="{!! old('seo_title', $store->seo_title) !!}" required name='seo_title' label='Store SEO Title' id='store_seo_title'/>
                                            </div>
                                            <div class='col-md'>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-10'>
                                                <x-admin.form.textarea notes='To Add DATE in your SEO Description Just Add phrase "(v_date)" at any place you want' value="{!! old('seo_description', $store->seo_description) !!}" required name='seo_description' label='Store SEO Description' rows="3" id='store_seo_description'/>
                                            </div>
                                            <div class='col-md'>
                                                <label class='d-block mb-4'></label>
                                        ...
                                        <x-admin.form.input value="{!! old('name', $store->name) !!}" required name='name' label='Store Name' id='store_name'/>
                                        
                                        <x-admin.form.input value="{!! old('slug', $store->slug) !!}" name='slug' required label='Store Slug' id='store_slug'/>
                                    ...
                                    <div class='row'>
                                        ...
                                        <x-admin.form.input value="{!! old('aff_link', $store->aff_link) !!}" name='aff_link' label='Store Affiliate Link' id='store_aff_link'/>
                                        <x-admin.form.input value="{!! old('link', $store->link) !!}" name='link' label='Store Link' id='store_link'/>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name='store_degree' class="single-select form-select select2-hidden-accessible" aria-hidden="true">
                                                        <option {{ $store->store_degree == 'premium' ? 'selected' : '' }} value='premium'>Premium</option>
                                                        <option {{ $store->store_degree == 'medium' ? 'selected' : '' }} value='medium'>Medium</option>
                                                        <option {{ $store->store_degree == 'lower' ? 'selected' : '' }} value='lower'>Lower</option>
                                                    </select>
							...
							<option value='All'>All Categories</option>
                                                        @foreach($categories as $key => $category)
                                                            <option {{ $store->categories->contains($key) ? 'selected' : '' }} value='{{ $key }}'>{{ $category }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="card">
                                            <div class="card-body p-4">
                                                ...
                                                <div class='row'>
                                                    <div class='col-md-8'>
                                                        <x-admin.form.input name='image' type='file' label='Store Image ( Recommended 100 x 100 )' id='store_image'/>
                                                    </div>
                                                    @if($store->image)
                                                        <div class='col-md-4 text-center'>
                                                            <img width='120' src="{{ asset('storage//images/markets/' . $store->image->path) }}" alt="">
                                                        </div>
                                                    @endif
                                                    
                                                    <div class='col-md-6'>
                                                        <x-admin.form.input value="{!! $store->image ? $store->image->alt : '' !!}" name='image_alt' type='text' label='Image Alt' id='image_alt'/>
                                                    </div>
                                                    
                                                    <div class='col-md-6'>
                                                        <x-admin.form.input value="{!! $store->image ? $store->image->title : '' !!}" name='image_title' type='text' label='Image Title' id='image_title'/>
                                                    </div>
                                                </div>
                                        ...
                                        <x-admin.form.input value="{!! old('about_store_1_title', $store->about_store_1_title) !!}" name='about_store_1_title' label='About Store title (1)' id='about_store_1_title'/>
                                        <x-admin.form.textarea value="{!! str_replace( '../../', '../../../', $store->about_store_1_description) !!}" name='about_store_1_description' label='About Store Description (1)' id='about_store_1_description' rows="4"/>
                                        
                                        <x-admin.form.input value="{!! old('about_store_2_title', $store->about_store_2_title) !!}" name='about_store_2_title' label='About Store title (2)' id='about_store_2_title'/>
                                        <x-admin.form.textarea value="{!! str_replace( '../../', '../../../', $store->about_store_2_description) !!}" name='about_store_2_description' label='About Store Description (2)' id='about_store_2_description' rows="4"/>
                                        
                                        <x-admin.form.input value="{!! old('about_store_3_title', $store->about_store_3_title) !!}" name='about_store_3_title' label='About Store title (3)' id='about_store_3_title'/>
                                        <x-admin.form.textarea value="{!! str_replace( '../../', '../../../', $store->about_store_3_description) !!}" name='about_store_3_description' label='About Store Description (3)' id='about_store_3_description' rows="4"/>
                                        
                                        <x-admin.form.input value="{!! old('about_store_4_title', $store->about_store_4_title) !!}" name='about_store_4_title' label='About Store title (4)' id='about_store_4_title'/>
                                        <x-admin.form.textarea value="{!! str_replace( '../../', '../../../', $store->about_store_4_description) !!}" name='about_store_4_description' label='About Store Description (4)' id='about_store_4_description' rows="4"/>
                                        
                                        <x-admin.form.input value="{!! old('about_store_5_title', $store->about_store_5_title) !!}" name='about_store_5_title' label='About Store title (5)' id='about_store_5_title'/>
                                        <x-admin.form.textarea value="{!! str_replace( '../../', '../../../', $store->about_store_5_description) !!}" name='about_store_5_description' label='About Store Description (5)' id='about_store_5_description' rows="4"/>
                                        
                                        <x-admin.form.input value="{!! old('about_store_6_title', $store->about_store_6_title) !!}" name='about_store_6_title' label='About Store title (6)' id='about_store_6_title'/>
                                        <x-admin.form.textarea value="{!! str_replace( '../../', '../../../', $store->about_store_6_description) !!}" name='about_store_6_description' label='About Store Description (6)' id='about_store_6_description' rows="4"/>
                                        
                                        <x-admin.form.input value="{!! old('about_store_7_title', $store->about_store_7_title) !!}" name='about_store_7_title' label='About Store title (7)' id='about_store_7_title'/>
                                        <x-admin.form.textarea value="{!! str_replace( '../../', '../../../', $store->about_store_7_description) !!}" name='about_store_7_description' label='About Store Description (7)' id='about_store_7_description' rows="4"/>
                                        
                                        <x-admin.form.input value="{!! old('about_store_8_title', $store->about_store_8_title) !!}" name='about_store_8_title' label='About Store title (8)' id='about_store_8_title'/>
                                        <x-admin.form.textarea value="{!! str_replace( '../../', '../../../', $store->about_store_8_description) !!}" name='about_store_8_description' label='About Store Description (8)' id='about_store_8_description' rows="4"/>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class='col-md-4'>
                                                ...
                                                <div class="form-check form-switch">
                                                    <input {{ $store->featured ? 'checked' : '' }} class="form-check-input" type="checkbox" name='featured' id="featured_checkbox">
                                            ...
                                            <div class='col-md-4'>
                                                ...
                                                <div class="form-check form-switch">
                                                    <input {{ $store->online ? 'checked' : '' }} class="form-check-input" type="checkbox" name='online' id="online_checkbox">
                                        ...
                                        <div id="widget-area1" class='d-none'>
                                            <div class="card card-body">
                                                ...
                                                <x-admin.form.textarea name='w_description[]' label='Widget Description' class='widget_description' id='widget_description' rows="3"/>
                    ...
                    <form class='hidden' id='delete_store_form' action="{{ route('admin.stores.destroy', $store) }}" method='POST'>
                        @csrf @method('DELETE')
                    </form>
                    ...
                    <div class="row row-cols-1 row-cols-md-1 row-cols-xl-1">
                        <h6 class='m-2 mb-4'>Store Widgets</h6>
