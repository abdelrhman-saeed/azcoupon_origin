                ...
                <div class="container-fluid">
                    <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                        <div class="col mx-auto">
                            ...
                            <p class='lead'>
                                You'll need to know tha following items before Proceeding.
                            </p>
                                        ...
                                        <div class="form-body">
                                            <form class="row g-3" method="POST" action="{{ route('install') }}" autocomplete='off'>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <label for="inputDBHost" class="form-label">Database Host</label>
                                                    <input name='dbhost' type="text" value='{{ old("dbhost") }}' class="form-control" id="inputDBHost" placeholder="DB Host ex: localhost">
